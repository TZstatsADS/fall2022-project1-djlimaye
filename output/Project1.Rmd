...
rows_to_keep=c()
for(i in seq_along(bag_of_words_german_idealism$word_new)){
  for(j in seq_along(word)){
     if(bag_of_words_german_idealism$word_new[i]==word[j]){
    rows_to_keep=c(rows_to_keep,i)
  }
  }
}
bag_of_words_german_idealism=bag_of_words_german_idealism[rows_to_keep,]
